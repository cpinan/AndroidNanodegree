 ...
 * on 2016-01-27 at 22:07:17 UTC 
 * Modify at your own risk.
 */

package com.carlospinan.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://just-circle-776.appspot.com/_ah/api/";
  ...
  public class GetJoke extends MyApiRequest<com.carlospinan.myapplication.backend.myApi.model.MyBean> {
     ...
     */
    protected GetJoke() {
      super(MyApi.this, "GET", REST_PATH, null, com.carlospinan.myapplication.backend.myApi.model.MyBean.class);
    }
  ...
  public class SayHi extends MyApiRequest<com.carlospinan.myapplication.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.carlospinan.myapplication.backend.myApi.model.MyBean.class);
